...
function EditExpenseForm(props) {
    ...
    const formattedDate = new Date(props.expense.created_at).toISOString().split('T')[0]
    ...
    function handleSubmit(e) {
        ...
        props.editExpense({id, description, amount, category, date});
    }
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
                <label className="form-control w-full">
                    <div className="label">
                        <span className="label-text">What is your new expense amount?</span>
                    </div>
                    <input
                        type="number"
                        value={amount}
