        ...
        <div className="card bg-base-200 w-72 shadow-md hover:shadow-3xl h-48">
            <div className="card-body">
                ...
                <div className="flex justify-around">
                    ...
                    {props.income >= props.expenses && //else the radial-progress is cooked
                        <div className="radial-progress mt-2"
                             style={{"--value": Math.floor((props.amount / props.income) * 100)}} role="progressbar">
